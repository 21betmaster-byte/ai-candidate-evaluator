...
18 brand-voice plain-text templates (pass/fail decision, missing items, non-PDF attachment, question response, auto-reply bounce, spam rejection, …). `RenderedEmail` dataclass (subject, body, template_key). Guarantee: no numeric scores or rubric terms in candidate-facing copy.
